export type ServerSidePath = string | Buffer | URL;
export type ClientSideFile = File | Blob;
...
declare function DetectFileEncodingAndLanguage(clientSideFileOrServerSidePath: ClientSideFile | ServerSidePath): Promise<FileInfo>;
